...
-   Leave Post-History alone for now; you'll add dates to this header each
    ...
    the Post-History header would look like:
        ...
        Post-History: 14-Aug-2009, 03-Sep-2009
   
    You must manually add new dates (use the first three letters of English
    month names) and check them in.  If you don't have check-in privileges,
    send your changes to the EEP editor.
